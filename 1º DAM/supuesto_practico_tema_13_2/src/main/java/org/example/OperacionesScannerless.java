...
public class OperacionesScannerless {
    public static void ingresarDatosInstanciasScannerless(EntityManager em) {
    ...
    public static void consultarProductosScannerless(EntityManager em) {
    ...
    public static void consultarProductosIdScannerless(EntityManager em) {
    ...
    public static void consultarProductosQueryScannerless(EntityManager em, int idBuscada) {
        System.out.println("Datos del producto buscado:");
        System.out.println("---------------------------");
        TypedQuery<Productos> consulta = em.createQuery("SELECT b FROM Productos b " +
                "WHERE b.id = :id", Productos.class);
        consulta.setParameter("id", idBuscada);
    ...
    public static void modificarDatosPorIdScannerless(EntityManager em) {
        em.getTransaction().begin();
    ...
    public static void modificarDatosPorQueryScannerless(EntityManager em) {
        em.getTransaction().begin();
    ...
    public static void borrarProductosPorIdScannerless(EntityManager em){
    ...
    public static void borrarProductosPorQueryScannerless(EntityManager em) {
        em.getTransaction().begin();
