...
class AcademiaTest {
    ...
    final static String ruta="src/main/java/ejercicio9/academia.dat";
    final static String ruta_backup="src/main/java/ejercicio9/academia.txt";
    final static String ruta_xml="src/main/java/ejercicio9/academia.xml";
    final static String ruta_json="src/main/java/ejercicio9/academia.json";
